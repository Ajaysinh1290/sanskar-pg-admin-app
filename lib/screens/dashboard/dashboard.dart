...
import 'package:sanskar_pg_admin_app/controllers/users_controller.dart';
import 'package:sanskar_pg_admin_app/screens/chat/chat_main_screen.dart';
import 'package:sanskar_pg_admin_app/screens/event/event_screen.dart';
import 'package:sanskar_pg_admin_app/screens/fees/fees_screen.dart';
import 'package:sanskar_pg_admin_app/screens/dashboard/drawer.dart';
import 'package:sanskar_pg_admin_app/screens/settings/settings.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<DashboardController>(builder: (controller) {
      return Scaffold(
        ...
        drawerEnableOpenDragGesture: controller.currentScreenIndex == 0,
