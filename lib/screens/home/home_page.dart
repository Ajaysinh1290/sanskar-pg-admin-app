...
import 'package:sanskar_pg_admin_app/screens/event/widgets/expanded_event_card.dart';
import 'package:sanskar_pg_admin_app/screens/food/foods.dart';
import 'package:sanskar_pg_admin_app/screens/notifications/notifications.dart';
...
import 'package:sanskar_pg_admin_app/widgets/cards/food_card.dart';
                          ...
                          FadeAnimationTranslateY(
                            ...
                            child: StreamBuilder(
                                stream: FirebaseFirestore.instance
                                    .collection('users')
                                    .where('hostelId',
                                        isEqualTo: hostel.hostelId)
                                    .where('isAccountApproved', isEqualTo: true)
                                    .where('isAccountRejected',
                                        isEqualTo: false)
                                    .snapshots(),
                                builder: (context, AsyncSnapshot snapshot) {
                                  int? users;
