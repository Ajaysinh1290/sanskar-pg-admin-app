...
import 'package:sanskar_pg_admin_app/screens/fees/users_rent.dart';
...
class FeesScreen extends StatelessWidget {
  ...
  double _getProgressValue() {
    ...
    double progressValue = 0.85;
    // for (var hostel in hostels) {
    //   if (hostel.hostelId == user!.hostelId) {
    //     for (var room in hostel.rooms) {
    //       if (room.roomId == user.roomId) {
    //         debugPrint('Room rent : ${room.roomRent}');
    //         debugPrint('Pending rent : ${user.pendingRent}');
    //         progressValue = user.pendingRent / room.roomRent;
    //         break;
    //       }
    //     }
    //   }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Get.to(UsersRent(), transition: Transition.rightToLeft);
        },
