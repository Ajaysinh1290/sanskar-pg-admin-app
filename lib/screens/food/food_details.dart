...
import 'package:sanskar_pg_admin_app/models/review/review.dart';
import 'package:sanskar_pg_admin_app/screens/food/add_food/add_food.dart';
import 'package:sanskar_pg_admin_app/screens/food/widgets/review_tile.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
              onPressed: () {
                if (food != null) showOptionsDialog(food);
              },
              icon: Icon(
                Icons.more_vert,
                size: 30.sp,
      ...
      body: StreamBuilder<Object>(
          ...
          builder: (context, AsyncSnapshot snapshot) {
            ...
            if (snapshot.hasData) {
              food = snapshot.data.data() == null
                  ? null
                  : Food.fromJson(snapshot.data.data());
            }
            return food == null
                ? Container()
                : ListView(
