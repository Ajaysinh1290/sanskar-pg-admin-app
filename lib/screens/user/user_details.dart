...
class UserDetails extends StatelessWidget {
  ...
  showOptionsDialog(UserModel? userModel) {
    Get.dialog(
        Align(
                ...
                child: SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: () async {
                          userModel!.isAccountBlocked =
                              !(userModel.isAccountBlocked ?? false);
                                    ...
                                    itemBuilder: (context, index) {
                                      return StreamBuilder<Object>(
                                          ...
                                          builder: (context,
                                            ...
                                            if (snapshot.hasData) {
                                              referredUser = UserModel.fromJson(
                                                  snapshot.data.data());
                                            }
