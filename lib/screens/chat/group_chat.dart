...
import 'package:sanskar_pg_admin_app/screens/chat/controller/group_chat_controller.dart';
...
import 'package:sanskar_pg_admin_app/widgets/image/full_image.dart';
          ...
          Padding(
            ...
            child: Row(
              children: [
                Expanded(
                  child: TextField(
                    controller: groupChatController.chatController,
                        ...
                        suffixIcon: GestureDetector(
                          onTap: () async {
                            ...
                            if (image != null) {
                              ...
                              groupChatController.scrollController.animateTo(0,
                                  duration: const Duration(milliseconds: 500),
                                  curve: Curves.easeIn);
                              groupChatController.chatController.text = '';
                ...
                Container(
                  ...
                  child: ValueListenableBuilder<bool>(
                      valueListenable: groupChatController.isLoading,
                      builder: (context, isLoading, _) {
                        return isLoading
                            ...
                            : InkWell(
                                onTap: () async {
                                  if (groupChatController.chatController.text
                                      .trim()
                                      .isNotEmpty) {
                                    ChatModel chatModel = ChatModel(
                                      sentBy: 'admin',
